        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Tambahkan kategori baru untuk pengelompokan asset perusahaan.
                </p>
            </div>
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
                ...
                <div class="border-b border-gray-200 bg-gray-50 px-6 py-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Isi informasi kategori asset dengan lengkap dan jelas.
                    </p>
                </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Gunakan kode unik untuk identifikasi kategori.
                                </p>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Nama kategori yang mudah dipahami pengguna.
                                </p>
